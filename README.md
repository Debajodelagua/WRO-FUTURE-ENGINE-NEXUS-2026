...
<div align="center">
 ...
 <br><br>
  ...
  [![Fusion 360](https://img.shields.io/badge/CAD-Autodesk_Fusion_360-E51B24.svg?style=for-the-badge&logo=autodesk)](https://www.autodesk.com/)
  [![Bambu Lab](https://img.shields.io/badge/3D_Printer-Bambu_Lab-00AE42.svg?style=for-the-badge)](https://bambulab.com/)
  <br>
...
| :--- | :---: | :--- |
| **Vista Superior<br>(Top View)** | <img src="./t-fotos/ANGULO%20DE%20ARRIBA.jpg" width="320" alt="Vista Superior Smoke" style="border-radius: 6px;"> | **Inspección de Simetría y Centro:**<br>• Permite verificar la posición concéntrica de la **IMU en el centro geométrico**.<br>• Muestra la distribución equilibrada de masas en el piso intermedio. |
| **Vista Frontal<br>(Front View)** | <img src="./t-fotos/ANGULO%20POR%20DELANTE.jpg" width="320" alt="Vista Frontal Smoke" style="border-radius: 6px;"> | **Inspección del Sistema de Visión:**<br>• Campo de visión libre e inclinación angular de la **HuskyLens**.<br>• Orientación axial del sensor ultrasónico central delantero. |
| **Vista Lateral Derecha<br>(Right Profile)** | <img src="./t-fotos/ANGULO%20IZQUIERDA.jpg" width="320" alt="Vista Lateral Derecha" style="border-radius: 6px;"> | **Inspección de Despeje y Altura:**<br>• Verificación del *Ground Clearance* (despeje al suelo) para evitar roces.<br>• Separación vertical entre el piso de potencia (Nivel 3) y lógica (Nivel 2). |
| **Vista Lateral Izquierda<br>(Left Profile)** | <img src="./t-fotos/ANGULO%20DERECHO.jpg" width="320" alt="Vista Lateral Izquierda" style="border-radius: 6px;"> | **Inspección de Ruteo Eléctrico:**<br>• Separación física del cableado de potencia y señales lógicas.<br>• Ubicación del sensor ultrasónico lateral para control de carril. |
| **Vista Trasera<br>(Rear View)** | <img src="./t-fotos/ANGULO%20POR%20ATRAS.jpg" width="320" alt="Vista Trasera Smoke" style="border-radius: 6px;"> | **Inspección del Tren de Tracción:**<br>• Montaje rígido del motor DC principal y alineación del eje de transmisión trasera. |
| **Vista Inferior<br>(Underbody View)** | <img src="./t-fotos/ANGULO%20POR%20DEBAJO.jpg" width="320" alt="Vista Inferior Chasis" style="border-radius: 6px;"> | **Inspección Estructural del Chasis:**<br>• Comprobación de las nervaduras de refuerzo impresas en PETG/PLA+.<br>• Área de barrido libre para el recorrido angular del brazo del servo. |
...
<div align="center">
  ...
  <img src="./t-fotos/ackermann_teoria.jpg" alt="Geometría Cinemática Ackermann" width="550" style="border-radius: 8px;">
</div>
  ...
  <table>
    <tr>
      <td align="center" width="50%">
        ...
        <img src="./t-fotos/Sistema%20de%20direccion.png" alt="CAD Ensamble Dirección" width="360" style="border-radius: 8px;">
        <br><i>Modelado del soporte de anclaje, servo MG90S y acoples.</i>
      </td>
      <td align="center" width="50%">
        <b>2. Principio Cinemático de Ackermann</b><br><br>
        <img src="./t-fotos/ackermann_teoria.jpg" alt="Diagrama Cinemático Ackermann" width="360" style="border-radius: 8px;">
    ...
    <tr>
      <td align="center" width="50%">
        ...
        <img src="./Otro/mecanismo_real.jpg" alt="Mecanismo Dirección Real" width="360" style="border-radius: 8px;">
        <br><i>Integración física del puente híbrido sobre el chasis inferior.</i>
      </td>
      <td align="center" width="50%">
        <b>4. Detalle del Brazo de Servo 3D</b><br><br>
        <img src="./Otro/brazo_servo_detalle.jpg" alt="Brazo de Servo en 3D" width="360" style="border-radius: 8px;">
...
| :---: | :---: | :---: | :---: | :--- |
| <img src="./v-photos/steer_left.jpg" width="220" alt="Viraje Izquierda" /> | **Viraje Máximo Izquierda** | $-38^\circ$ a $-40^\circ$ | $\approx 1050 \ \mu s$ | Evasión rápida de pilares rojos y cierre de curva interna. |
| <img src="./v-photos/steer_center.jpg" width="220" alt="Posición Neutra" /> | **Centro Neutro (Línea Recta)** | $0^\circ$ | $1500 \ \mu s$ | Mínima resistencia de rodadura y aceleración máxima en rectas. |
| <img src="./v-photos/steer_right.jpg" width="220" alt="Viraje Derecha" /> | **Viraje Máximo Derecha** | $+38^\circ$ a $+40^\circ$ | $\approx 1950 \ \mu s$ | Evasión rápida de pilares verdes y trazado de curvas abiertas. |
</div>
